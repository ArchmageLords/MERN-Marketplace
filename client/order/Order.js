    ...
    return (
      <Card className={classes.card}>
        ...
        <Typography type="subheading" component="h2" className={classes.subheading}>
            Код заказа: <strong>{order._id}</strong> <br/> Размещено {(new Date(order.created)).toDateString()}
        </Typography><br/>
        <Grid container spacing={4}>
                      ...
                      <Card className={classes.cart} >
                        ...
                        <div className={classes.details}>
                          <CardContent className={classes.content}>
                            ...
                            <span className={classes.itemShop}>Магазин: {item.shop.name}</span>
                            <Typography type="subheading" component="h3" color={item.status == "Cancelled" ? "error":"secondary"}>Заказ: {item.status}</Typography>
                          </CardContent>
                        </div>
                      </Card>
                      <Divider/>
            ...
            <Grid item xs={5} sm={5}>
              <Card className={classes.innerCard}>
                ...
                <Typography type="subheading" component="h3" className={classes.thanks} color="primary">Спасибо, что покупаете с нами! <br/>Вы можете отследить статус заказа на этой странице.</Typography>
              </Card>
            </Grid>
        </Grid>
      </Card>
