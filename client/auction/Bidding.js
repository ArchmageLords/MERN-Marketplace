    ...
    return(
        <div>
            {!props.justEnded && new Date() < new Date(props.auction.bidEnd) && <div className={classes.placeForm}>
                ...
                <Button variant="contained" className={classes.marginBtn} color="secondary" disabled={bid < (minBid + 1)} onClick={placeBid} >Поставить ставку</Button><br/>
            </div>}
            <div className={classes.bidHistory}>
                <Typography variant="h6">Все ставки</Typography><br/>
                <Grid container spacing={4}>
                    <Grid item xs={3} sm={3}>
                        <Typography variant="subtitle1" color="primary">Объём ставки</Typography>
                    </Grid>
                    <Grid item xs={5} sm={5}>
