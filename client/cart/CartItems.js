...
export default function CartItems (props) {
  ...
  const openCheckout = () => {
    ...
    return (<Card className={classes.card}>
      ...
      {cartItems.length>0 ? (<span>
        ...
        <div className={classes.checkout}>
          ...
          {!props.checkout && (auth.isAuthenticated()?
            <Button color="secondary" variant="contained" onClick={openCheckout}>Заказать</Button>
            :
            <Link to="/signin">
              <Button color="primary" variant="contained">Войти, чтобы заказать</Button>
            </Link>)}
      ...
      <Typography variant="subtitle1" component="h3" color="primary">Нет товаров в вашей корзине</Typography>
    }
    </Card>)
}
