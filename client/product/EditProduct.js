  ...
  const handleChange = name => event => {
    ...
    return (<div>
      <Card className={classes.card}>
        ...
        <CardActions>
          <Button color="primary" variant="contained" onClick={clickSubmit} className={classes.submit}>Обновить</Button>
          <Link to={'/seller/shops/edit/'+match.params.shopId} className={classes.submit}><Button variant="contained">Отмена</Button></Link>
        </CardActions>
      </Card>
    </div>)
}
