  ...
  const clickSubmit = () => {
    ...
    return (<div>
      <Card className={classes.card}>
        ...
        <CardActions>
          <Button color="primary" variant="contained" onClick={clickSubmit} className={classes.submit}>Подтвердить</Button>
          <Link to={'/seller/shop/edit/'+match.params.shopId} className={classes.submit}><Button variant="contained">Отмена</Button></Link>
        </CardActions>
      </Card>
    </div>)
}
